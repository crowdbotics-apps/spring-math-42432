"""
Django settings for spring_math_42432 project.
...
ROOT_URLCONF = 'spring_math_42432.urls'
...
WSGI_APPLICATION = 'spring_math_42432.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "spring_math_42432 API",
    "DESCRIPTION": "API documentation for spring_math_42432 App",
    "VERSION": "v1",
}
